...
class ProviderApp extends StatelessWidget {
  ...
  void setupLocators() {
    ...
    GetIt.instance.registerSingleton<MainModel>(MainModel(repository: repository));
    GetIt.instance.registerSingleton<LoginViewModel>(LoginViewModel(repository: repository));
  }
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        AppRoutes.home: (context) => LoginScreen(LoginView()),
